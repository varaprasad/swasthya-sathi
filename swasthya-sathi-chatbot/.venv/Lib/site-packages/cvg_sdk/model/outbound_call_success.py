...
def lazy_import():
    ...
    from cvg_sdk.model.outbound_call_success_all_of import OutboundCallSuccessAllOf
    ...
    globals()['OutboundCallSuccessAllOf'] = OutboundCallSuccessAllOf


class OutboundCallSuccess(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """OutboundCallSuccess - a model defined in OpenAPI

        Keyword Args:
            dialog_id (str): The id of a dialog.
            ring_start_timestamp (int): An instant of time, measured in milliseconds since the epoch (1970-01-01) in UTC.
            status (str):
