...
def lazy_import():
    ...
    from cvg_sdk.model.synthesis_parameters_all_of import SynthesisParametersAllOf
    ...
    globals()['SynthesisParametersAllOf'] = SynthesisParametersAllOf
    globals()['SynthesizerSelection'] = SynthesizerSelection


class SynthesisParameters(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'text': (str,),  # noqa: E501
            'interpret_as': (InterpretAs,),  # noqa: E501
            'language': (Language,),  # noqa: E501
            'synthesizers': (SynthesizerSelection,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'interpret_as': 'interpretAs',  # noqa: E501
        'language': 'language',  # noqa: E501
        'synthesizers': 'synthesizers',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SynthesisParameters - a model defined in OpenAPI

        Keyword Args:
            dialog_id (str): The id of a dialog.
            text (str): The text to be synthesized. The text must not consist solely of whitespace.  We recommend always setting the `interpretAs` property as it avoids mis-detections and enables some basic SSML validation. If `interpretAs` is missing, the platform will try to automatically determine if the text is SSML or plain text.  Valid SSML has to be surrounded with a `<speak>` tag. An explicit XML declaration is not required.  Note that SSML may be modified slightly for better compatibility with different text-to-speech services (mostly inserting required boilerplate).
            ...
            interpret_as (InterpretAs): [optional]  # noqa: E501
            language (Language): [optional]  # noqa: E501
            synthesizers (SynthesizerSelection): [optional]  # noqa: E501
