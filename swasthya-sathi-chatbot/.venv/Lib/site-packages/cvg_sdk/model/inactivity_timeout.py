...
class InactivityTimeout(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """InactivityTimeout - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (int): Duration after which the inactivity detection timeout occurs. The value is in milliseconds..  # noqa: E501

        Keyword Args:
            value (int): Duration after which the inactivity detection timeout occurs. The value is in milliseconds..  # noqa: E501
