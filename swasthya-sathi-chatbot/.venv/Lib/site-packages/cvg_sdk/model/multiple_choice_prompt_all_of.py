...
class MultipleChoicePromptAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'choices': ({str: (Synonyms,)},),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, choices, *args, **kwargs):  # noqa: E501
        """MultipleChoicePromptAllOf - a model defined in OpenAPI

        Args:
            choices ({str: (Synonyms,)}):
