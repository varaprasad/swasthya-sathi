...
class TranscriptEntry(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, timestamp, speaker, *args, **kwargs):  # noqa: E501
        """TranscriptEntry - a model defined in OpenAPI

        Args:
            type (str):
            timestamp (int): The timestamp is the amount of milliseconds since the beginning of the recording.
            speaker (Speaker):
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, timestamp, speaker, *args, **kwargs):  # noqa: E501
        """TranscriptEntry - a model defined in OpenAPI
