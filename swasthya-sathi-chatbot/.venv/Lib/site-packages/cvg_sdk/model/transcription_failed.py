...
def lazy_import():
    ...
    globals()['SpeechServiceFailedProperties'] = SpeechServiceFailedProperties
...
class TranscriptionFailed(ModelComposed):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'configuration': (SpeechServiceConfiguration,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TranscriptionFailed - a model defined in OpenAPI

        Keyword Args:
            configuration (SpeechServiceConfiguration):
            error_code (str): Error code that should be included in support inquiries.
            type (str):
