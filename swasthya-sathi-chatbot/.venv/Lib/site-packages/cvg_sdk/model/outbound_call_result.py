...
class OutboundCallResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, status, ring_time, *args, **kwargs):  # noqa: E501
        """OutboundCallResult - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, status, ring_time, *args, **kwargs):  # noqa: E501
        """OutboundCallResult - a model defined in OpenAPI
