...
class ProjectHealthEvent(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, count, status, *args, **kwargs):  # noqa: E501
        """ProjectHealthEvent - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, count, status, *args, **kwargs):  # noqa: E501
        """ProjectHealthEvent - a model defined in OpenAPI
