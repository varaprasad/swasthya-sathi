...
class AcceptAssistParameters(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, reseller_token, phone_number, callback_url, *args, **kwargs):  # noqa: E501
        """AcceptAssistParameters - a model defined in OpenAPI

        Args:
            reseller_token (str): The unique token of a reseller. You can find your token on your project configuration page.
            phone_number (str): A phone number (+E.164 format) registered at our platform for inbound calling.
            callback_url (str): The base URL for sending transcription events.
        ...
        Keyword Args:
            ...
            auth_token (str): A token that is used to authenticate requests to the callback URL.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, reseller_token, phone_number, callback_url, *args, **kwargs):  # noqa: E501
        """AcceptAssistParameters - a model defined in OpenAPI
