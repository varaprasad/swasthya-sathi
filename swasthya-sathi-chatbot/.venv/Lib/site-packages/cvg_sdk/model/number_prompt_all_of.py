...
class NumberPromptAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'submit_inputs': (Synonyms,),  # noqa: E501
    ...
    attribute_map = {
        'submit_inputs': 'submitInputs',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NumberPromptAllOf - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            submit_inputs (Synonyms): [optional]  # noqa: E501
            min_digits (int): The minimum amount of digits the number can have. Must not be greater than `maxDigits`. If this property is set and smaller than `maxDigits`, a prompt timeout will not lead to a `Timeout` answer, but to a `Number` answer with the digits entered thus far.. [optional]  # noqa: E501
            max_digits (int): The maximum amount of digits the number can have. If this property is set, input terminates once the limit has been reached.. [optional]  # noqa: E501
        """
