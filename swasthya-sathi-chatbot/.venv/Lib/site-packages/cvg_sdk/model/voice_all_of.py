...
class VoiceAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, text, confidence, *args, **kwargs):  # noqa: E501
        """VoiceAllOf - a model defined in OpenAPI

        Args:
            text (str): The text as it has been detected by speech recognition.
    ...
    @convert_js_args_to_python_args
    def __init__(self, text, confidence, *args, **kwargs):  # noqa: E501
        """VoiceAllOf - a model defined in OpenAPI
