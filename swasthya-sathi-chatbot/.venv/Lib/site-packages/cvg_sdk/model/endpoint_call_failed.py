...
def lazy_import():
    ...
    globals()['EndpointCallFailedAllOf'] = EndpointCallFailedAllOf
...
class EndpointCallFailed(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'type': (str,),  # noqa: E501
            'count': (int,),  # noqa: E501
            'status': (HealthEventStatus,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """EndpointCallFailed - a model defined in OpenAPI

        Keyword Args:
            url (str): The request URL (base URL + endpoint like /session)
            api (str): Which API the URL belongs to.
            type (str):
            count (int): How often this event happened within the checked time period.
            ...
            message (str): Error message describing what went wrong during the call.. [optional]  # noqa: E501
        """
