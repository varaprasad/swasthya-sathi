...
def lazy_import():
    ...
    globals()['ForwardAllOf'] = ForwardAllOf
...
class Forward(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            destination (str): A phone number (+E.164 format) or a SIP address for outgoing calls.  Note that when using a SIP address, the call is routed via public Internet, so there are no quality of service guarantees.
