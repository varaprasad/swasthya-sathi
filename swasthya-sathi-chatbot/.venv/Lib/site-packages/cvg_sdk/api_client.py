...
from cvg_sdk import rest
from cvg_sdk.configuration import Configuration
from cvg_sdk.exceptions import ApiTypeError, ApiValueError, ApiException
from cvg_sdk.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_project_health  # this is an instance of the class Endpoint
        api_instance.get_project_health()  # this invokes api_instance.get_project_health.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_project_health.callable or self.callable in this class
